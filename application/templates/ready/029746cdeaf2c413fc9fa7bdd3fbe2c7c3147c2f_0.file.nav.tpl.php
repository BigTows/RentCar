<?php
/* Smarty version 3.1.30, created on 2017-04-27 10:50:47
  from "/var/www/html/cars/application/templates/adminpanel/nav.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
    'unifunc' => 'content_5901a2d7103684_30526797',
  ...
  array (
    ...
    function content_5901a2d7103684_30526797(Smarty_Internal_Template $_smarty_tpl)
    {
?>
...
?>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="tables">
                        <?php
                        $_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['data']->value['view_tables'], 'link', false, 'name');
                        if ($_from !== null) {
                            foreach ($_from as $_smarty_tpl->tpl_vars['name']->value => $_smarty_tpl->tpl_vars['link']->value) {
                                ?>
